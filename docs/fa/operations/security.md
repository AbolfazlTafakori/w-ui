---
description: "پنل برای محافظت از خودش چه می‌کند و تو روی آن چه کنی: فایروال، ورود دومرحله‌ای، بک‌آپ بیرون از سرور."
---
...
- **خبر دادن پیش از انقضای گواهی.** تنظیمات ← امنیت هشدار می‌دهد وقتی گواهی‌ای که پنل یا سرویس سابسکریپشن با آن سرو می‌شود کمتر از دو هفته وقت دارد، و بعد از انقضا بلندتر می‌گوید. تمدید همچنان کار نصاب و acme.sh است؛ این فقط کاری است که پنل می‌کند تا انقضا را از مشتری نشنوی.
