...
فایل `.ovpn` که پنل می‌سازد خودکفاست — CA، کلید `tls-crypt` و آدرس سرور داخلش هستند — پس با یک ضربه وارد می‌شود. مشتری با **نام کاربری و رمزی** که در اطلاعات مشتری هست وارد می‌شود؛ سرتیفیکیت جداگانه‌ای برای نصب نیست.
