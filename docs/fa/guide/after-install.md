---
description: "نصاب با هر چیزی که لازم داری روی یک صفحه تمام می‌شود. قبل از بستن ترمینال جایی امن کپی کن."
---

# بعد از نصب

نصاب با هر چیزی که لازم داری روی یک صفحه تمام می‌شود. قبل از بستن ترمینال جایی امن کپی کن.
