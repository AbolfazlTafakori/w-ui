...
تنظیمات → سابسکریپشن می‌تواند سرویس سابسکریپشن را روی لیسنر جداگانه با سرتیفیکیت خودش بگذارد. لینکی که به مشتری داده می‌شود آن پورت و scheme را دارد، پس `https://your.host:2096/sub/TOKEN` مثل سنایی کار می‌کند.
